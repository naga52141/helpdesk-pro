...
INSERT INTO canned_responses (title, body, created_by) VALUES
  ('Requesting more information', 'Thanks for reaching out. Could you share a bit more detail — when this started, any error messages you''re seeing, and the device/browser you''re using? That''ll help us get this resolved faster.', 2),
  ('Password reset confirmation', 'Your password has been reset and MFA has been re-enrolled. Please log in with the temporary credentials sent to your email and set a new password on first login.', 2),
  ('Escalation notice', 'This issue has been escalated to our specialist team. We''ll follow up here as soon as we have an update — typically within one business day.', 3),
  ('Closing resolved ticket', 'This ticket is now resolved. If the issue comes back or you have any follow-up questions, feel free to reopen it or reply here and we''ll take another look.', 2);
